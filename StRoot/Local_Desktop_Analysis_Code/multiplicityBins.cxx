...
int multiplicityBins(){
    ...
    TString inputFileName  = "C:/Users/ajentsch/Desktop/D0_Hadron_Correlation_Root_Files/9_Eta_12_Phi_bins.root";
    TString outputFileName = "C:/Users/ajentsch/Desktop/multiplicityOutput.root"; 
    TString run4FileName = "C:/Users/ajentsch/Desktop/Run4PowerLaw.txt";
    ...
    TString multiplicityDistLabel = "Used tracks";
    
    TH1I* h = new TH1I("Used tracks", "Used tracks", 1500, 0, 1499);
    ...
    c->SaveAs("C:/Users/ajentsch/desktop/mult.png");
    
    normPowerLawPlot->Draw("C");
    normRun4PowerLawPlot->Draw("C SAME");
    c->SaveAs("C:/Users/ajentsch/desktop/mult2.png");
