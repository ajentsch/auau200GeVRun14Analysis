...
StMixerTrack::StMixerTrack() : mMom(StThreeVectorF()), mPIDFlag(-1), mCharge(0), mMass(-1), mKaonIdx(-1), mPionIdx(-1)
{
}
...
StMixerTrack::StMixerTrack(StThreeVectorF trackMomentum, double mass, int kaonIdx, int pionIdx, int charge){
